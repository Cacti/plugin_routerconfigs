...
$devicetype_edit = array(
    'name' => array(
        ...
        'description' => __('Name of this device type.'),
        'value' => '|arg1:name|',
		'size' => '30',
        'max_length' => '64',
    ),
    'username' => array(
        'method' => 'textbox',
        'friendly_name' => __('Username Prompt'),
        'description' => __('This is the username prompt to match on login.'),
        'value' => '|arg1:username|',
		'size' => '20',
        'max_length' => '64',
    ),
    'password' => array(
        'method' => 'textbox',
        'friendly_name' => __('Password Prompt'),
        'description' => __('This is the password prompt to match on login.'),
        'value' => '|arg1:password|',
		'size' => '20',
        'max_length' => '255',
    ),
    'copytftp' => array(
        'method' => 'textbox',
        'friendly_name' => __('Copy TFTP'),
        'description' => __('This is the CLI text used to send the backup to tftp server.'),
        'value' => '|arg1:copytftp|',
		'size' => '20',
        'max_length' => '64',
    ),
    'version' => array(
        'method' => 'textbox',
        'friendly_name' => __('Show Version'),
        'description' => __('This is the CLI text used to display the current version.'),
        'value' => '|arg1:version|',
		'size' => '20',
        'max_length' => '64',
    ),
    'confirm' => array(
        'method' => 'textbox',
        'friendly_name' => __('Confirm'),
        'description' => __('Is there a confirmation prompt for copying the config?'),
        'value' => '|arg1:confirm|',
		'size' => '10',
        'max_length' => '64',
    ),
    'forceconfirm' => array(
        'method' => 'checkbox',
        'friendly_name' => __('Force Confirm'),
        'description' => __('Is there a force confirmation prompt for copying the config?'),
        'value' => '|arg1:forceconfirm|',
        'default' => 'on',
    ),
    'checkendinconfig' => array(
        'method' => 'checkbox',
        'friendly_name' => __('Check End in Config'),
        'description' => __('Check end in config?'),
...
function show_devicetypes() {
	...
	if (sizeof($result)) {
		...
		print "<tr class='even'><td colspan='11'>" . __('No Router Device Types Found') . "</td></tr>\n";
	}
